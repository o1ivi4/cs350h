...
def iterate_cast(conn): 
    ...
    try: 
        ...
        print("Successfully iterated over cast table")
        return cast
    except ZeroDivisionError as e: 
        curs.close()
        return "Error iterating over credits table."
...
def write_js(filename, movies, cast, staff): 
